...
2026-08-16. Squashed into `main` as `4d92865`; the individual commits this entry was written
against (`ac33bd5..108d2f7`) survive only on the local branch and tag `pre-squash/2026-08-16`
and are gone from the remote. The seam is
